...
sudo kubeadm upgrade apply v1.22.5  #<---this format is different than the package's version format
...
sudo apt-get update
sudo apt-get install -y kubelet=1.22.5-00 kubectl=1.22.5-00
